...
export async function POST(req) {
  ...
  let cleanedAddress = address.replace("0x", "");
  await walletClient.sendTransaction({
    account,
    data: `0x84bb1e42000000000000000000000000${cleanedAddress}`,
    to: nftAddress,
    nonce: nonce,
  });
  nonce++
